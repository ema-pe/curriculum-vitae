...
% ATTENZIONE: SPOSTARE TUTTO SU UN PROGETTO SOTTO MARCO SAVI.
% CAMBIARE TEMPLATE, VEDERE:
%
%   - https://sebastiano.tronto.net/tronto-cv.pdf
...
\else
    ...
    \leftheader{%
      ...
      \makefield{\faClock}{CV updated to 2025-12-16}
    }
\fi
