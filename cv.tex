...
\personalinfo{%
    ...
    \location{Aggiornato al 2022-10-01} \\
...
\begin{itemize}\setlength\itemsep{0.2em}
\item Contributore a \textbf{Fedora Project} per la localizzazione in italiano dei contenuti tramite l'uso della piattaforma Weblate.
...
\item Contributore a una moltitudine di progetti minori, sia personali che della comunità, in tutti i suoi aspetti: documentazione, sviluppo, testing, supporto, localizzazione e altro.
\end{itemize}
